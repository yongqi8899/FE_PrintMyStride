...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 flex text-gray-700 align-middle bg-primary navbar bold">
          ...
          {itAuth ? (
            ...
            <li>
              ...
              >
                ...
                <ul className="p-2 rounded-t-none flex flex-col bg-primary">
                  <li>
                    <NavLink to="/login" onClick={closeDetails}>
                      <p> Me</p>
                    </NavLink>
          ...
          <li>
            <label className="swap swap-rotate">
              ...
              <input
                ...
                value="synthwave"
                onClick={()=> setTheme(t => t === "light" ? "light": "dark")}
              />
